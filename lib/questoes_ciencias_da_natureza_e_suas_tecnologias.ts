...
import { questoes } from './questoes_ciencias_da_natureza';
...
export const CIENCIAS_DA_NATUREZA_E_SUAS_TECNOLOGIAS_DATA: Questao[] = generateProceduralQuestions('NATUREZA', baseData, 560);
