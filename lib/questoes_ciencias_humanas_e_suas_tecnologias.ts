...
import { questoes } from './questoes_ciencias_humanas';
...
export const CIENCIAS_HUMANAS_E_SUAS_TECNOLOGIAS_DATA: Questao[] = generateProceduralQuestions('HUMANAS', baseData, 560);
