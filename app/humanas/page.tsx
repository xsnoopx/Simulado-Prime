...
export default function HumanasPage() {
  ...
  const { questions, setQuestions, loading } = useQuestions('humanas', HUMANAS_DATA);
  ...
  const handleCheckAnswer = () => {
    ...
    recordAnswer('humanas', isCorrect);
  };
          ...
          <header className="mb-8 flex items-center justify-between">
            ...
            <div className="text-center flex-1">
              <div className="flex items-center justify-center gap-2">
                <h1 className="text-2xl font-display font-bold uppercase tracking-widest text-primary-light">C. Humanas</h1>
                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-primary/10 border border-primary/20">
                  ...
                  <span className="text-[8px] font-bold text-primary-light tracking-wider uppercase">Cosmos</span>
                </div>
              </div>
          ...
          <AnimatePresence mode="wait">
            {isFinished ? (
              <>
                ...
                >
                <div className="absolute top-0 left-0 right-0 h-1.5 bg-primary/40" />
                ...
                <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-2">
                  ...
                  <p className="text-4xl font-display font-bold text-primary-light">
                ...
                <ShareResults
                  ...
                  categoryName="Ciências Humanas"
                  themeColor="blue"
                  textTrigger="Compartilhar Simulado Concluído 🚀"
                />

                <ExpertExplanation missedQuestions={missedQuestions} subject="Ciências Humanas" />

                <button
                  onClick={handleReset}
                  className="w-full py-4 gradient-primary text-white font-display font-bold tracking-widest rounded-2xl shadow-xl shadow-primary/20 flex items-center justify-center gap-3 active:scale-95 transition-all"
                >
              ...
              >
                <div className="flex flex-wrap gap-2">
                  <div className="px-3 py-1 bg-primary/10 rounded-full border border-primary/20 flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-primary-light uppercase tracking-wider">Ciências Humanas e suas Tecnologias</span>
                  </div>
                  ...
                  <div className="glass-panel rounded-2xl border border-white/5 p-4 relative overflow-hidden">
                    <div className="flex items-center justify-between text-xs mb-2">
                      <div className="flex items-center gap-1.5 text-white/50">
                        <Timer className="w-3.5 h-3.5 text-primary-light animate-pulse" />
                    ...
                    <div className="w-full bg-white/5 rounded-full h-1 overflow-hidden relative">
                      <motion.div 
                        className={cn(
                          ...
                          timeLeft <= configuredSeconds / 2 ? "bg-amber-500" : "bg-primary"
                        )}
                        ...
                        <AnimatePresence>
                          {selectedAnswer && !showResult && (
                            <motion.button
                              ...
                              className="w-full py-4 gradient-primary rounded-2xl text-white font-display font-bold tracking-widest shadow-xl shadow-primary/20 flex items-center justify-center gap-3 active:scale-95 transition-all"
                            >
                              CONFERIR RESPOSTA
