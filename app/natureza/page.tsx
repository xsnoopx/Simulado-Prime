...
export default function NaturezaPage() {
  ...
  const { questions, setQuestions, loading } = useQuestions('natureza', NATUREZA_DATA);
  ...
  const handleCheckAnswer = () => {
    ...
    recordAnswer('natureza', isCorrect);
  };
  ...
  return (
    <div className="relative h-screen flex flex-col overflow-hidden">
      ...
      {/* Background Orbs */}
      <div className="absolute top-[-5%] right-[-5%] w-[500px] h-[500px] bg-green-500/10 blur-[120px] rounded-full -z-10" />
      <div className="absolute bottom-[10%] left-[-10%] w-[400px] h-[400px] bg-emerald-500/10 blur-[100px] rounded-full -z-10" />
          ...
          <header className="mb-8 flex items-center justify-between">
            ...
            <div className="text-center flex-1">
              <div className="flex items-center justify-center gap-2">
                <h1 className="text-2xl font-display font-bold uppercase tracking-widest text-[#4ade80]">C. Natureza</h1>
                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-green-500/10 border border-green-500/20">
                  ...
                  <span className="text-[8px] font-bold text-[#4ade80] tracking-wider uppercase">Cosmos</span>
                </div>
              </div>
          ...
          <AnimatePresence mode="wait">
            {isFinished ? (
              <>
                ...
                >
                <div className="absolute top-0 left-0 right-0 h-1.5 bg-green-500/40" />
                ...
                <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-2">
                  ...
                  <p className="text-4xl font-display font-bold text-[#4ade80]">
                ...
                <ShareResults
                  ...
                  categoryName="Ciências da Natureza"
                  themeColor="emerald"
                  textTrigger="Compartilhar Simulado Concluído 🚀"
                />

                <ExpertExplanation missedQuestions={missedQuestions} subject="Ciências da Natureza" />

                <button
                  onClick={handleReset}
                  className="w-full py-4 gradient-natureza text-white font-display font-bold tracking-widest rounded-2xl shadow-xl shadow-green-500/20 flex items-center justify-center gap-3 active:scale-95 transition-all"
                >
              ...
              >
                <div className="flex flex-wrap gap-2">
                  <div className="px-3 py-1 bg-green-500/10 rounded-full border border-green-500/20 flex items-center gap-2">
                    <FlaskConical className="w-3 h-3 text-[#4ade80]" />
                    <span className="text-[10px] font-bold text-[#4ade80] uppercase tracking-wider">Ciências da Natureza e suas Tecnologias</span>
                  </div>
                  ...
                  <div className="glass-panel rounded-2xl border border-white/5 p-4 relative overflow-hidden">
                    <div className="flex items-center justify-between text-xs mb-2">
                      <div className="flex items-center gap-1.5 text-white/50">
                        <Timer className="w-3.5 h-3.5 text-[#4ade80] animate-pulse" />
                    ...
                    <div className="w-full bg-white/5 rounded-full h-1 overflow-hidden relative">
                      <motion.div 
                        className={cn(
                          ...
                          timeLeft <= configuredSeconds / 2 ? "bg-amber-500" : "bg-[#4ade80]"
                        )}
                ...
                <div className="glass-panel rounded-3xl border border-white/5 shadow-2xl overflow-hidden relative">
                  <div className="h-1.5 w-full bg-green-500/40" />
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                isSelected ? "border-green-500 bg-green-500/10" : "border-white/5 bg-white/5 hover:bg-white/10",
                            ...
                            >
                              <div className={cn(
                                ...
                                isSelected ? "bg-green-500 text-white" : "bg-white/10 text-on-surface-variant group-hover:bg-green-500/20",
                        ...
                        <AnimatePresence>
                          {selectedAnswer && !showResult && (
                            <motion.button
                              ...
                              className="w-full py-4 gradient-natureza rounded-2xl text-white font-display font-bold tracking-widest shadow-xl shadow-green-500/20 flex items-center justify-center gap-3 active:scale-95 transition-all"
                            >
                              CONFERIR RESPOSTA
                        ...
                        <AnimatePresence>
                          {showResult && (
                            <motion.div
                              ...
                              className="bg-green-500/5 rounded-2xl border border-green-500/10 p-4 space-y-4"
                            >
                              <div className="flex items-center justify-between">
                                  ...
                                  <button 
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-green-500 text-white rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-green-600 transition-all"
                                  >
                                    Próxima Questão
