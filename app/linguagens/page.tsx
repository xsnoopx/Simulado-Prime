...
export default function LinguagensPage() {
  ...
  const { questions, setQuestions, loading } = useQuestions('linguagens', LINGUAGENS_DATA);
  ...
  const handleCheckAnswer = () => {
    ...
    recordAnswer('linguagens', isCorrect);
  };
  ...
  return (
    <div className="relative h-screen flex flex-col overflow-hidden">
      ...
      {/* Background Orbs */}
      <div className="absolute top-[-5%] right-[-5%] w-[500px] h-[500px] bg-secondary/10 blur-[120px] rounded-full -z-10" />
          ...
          <header className="mb-8 flex items-center justify-between">
            ...
            <div className="text-center flex-1">
              <div className="flex items-center justify-center gap-2">
                <h1 className="text-2xl font-display font-bold uppercase tracking-widest text-secondary">Linguagens</h1>
                <div className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-secondary/10 border border-secondary/20">
                  ...
                  <span className="text-[8px] font-bold text-secondary tracking-wider uppercase">Cosmos</span>
                </div>
              </div>
          ...
          <AnimatePresence mode="wait">
            {isFinished ? (
              <>
                ...
                >
                <div className="absolute top-0 left-0 right-0 h-1.5 bg-secondary/40" />
                <div className="space-y-2">
                  <div className="mx-auto w-16 h-16 rounded-full bg-secondary/10 flex items-center justify-center border border-secondary/20">
                ...
                <ShareResults
                  ...
                  categoryName="Linguagens e Códigos"
                  themeColor="indigo"
                  textTrigger="Compartilhar Simulado Concluído 🚀"
                />

                <ExpertExplanation missedQuestions={missedQuestions} subject="Linguagens" />

                <button
                  onClick={handleReset}
                  className="w-full py-4 gradient-secondary text-white font-display font-bold tracking-widest rounded-2xl shadow-xl shadow-secondary/20 flex items-center justify-center gap-3 active:scale-95 transition-all"
                >
              ...
              >
                <div className="flex flex-wrap gap-2">
                  <div className="px-3 py-1 bg-secondary/10 rounded-full border border-secondary/20 flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-secondary uppercase tracking-wider">Linguagens, Códigos e suas Tecnologias</span>
                  </div>
                    ...
                    <div className="w-full bg-white/5 rounded-full h-1 overflow-hidden relative">
                      <motion.div 
                        className={cn(
                          ...
                          timeLeft <= configuredSeconds / 2 ? "bg-amber-500" : "bg-secondary"
                        )}
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                isSelected ? "border-secondary bg-secondary/10" : "border-white/5 bg-white/5 hover:bg-white/10",
                            ...
                            >
                              <div className={cn(
                                ...
                                isSelected ? "bg-secondary text-white" : "bg-white/10 text-on-surface-variant group-hover:bg-secondary/20",
                        ...
                        <AnimatePresence>
                          {selectedAnswer && !showResult && (
                            <motion.button
                              ...
                              className="w-full py-4 gradient-secondary rounded-2xl text-white font-display font-bold tracking-widest shadow-xl shadow-secondary/20 flex items-center justify-center gap-3 active:scale-95 transition-all"
                            >
                              CONFERIR RESPOSTA
                        ...
                        <AnimatePresence>
                          {showResult && (
                            <motion.div
                              ...
                              className="bg-secondary/5 rounded-2xl border border-secondary/10 p-4 space-y-4"
                            >
                              <div className="flex items-center justify-between">
                                  ...
                                  <button 
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-secondary text-white rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-secondary/80 transition-all"
                                  >
                                    Próxima Questão
